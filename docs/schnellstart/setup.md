...
Sie benötigen eine **Claude Code Subscription** von [claude.ai](https://claude.ai). ComplianceOS verwendet die gleiche Authentifizierung wie die Claude CLI.
...
4. Der Browser leitet Sie automatisch zurück zu ComplianceOS
...
6. Fügen Sie den Code in das Eingabefeld auf der ComplianceOS-Seite ein
7. Klicken Sie auf **"Code absenden"**

!!! warning "Code-Gültigkeit"
...
| Scope | Verwendung |
|-------|-----------|
| `user:inference` | KI-Anfragen für Chat und Audit-Bewertungen |
| `user:profile` | Benutzername für Anzeige |
...
1. [Erste Schritte](erste-schritte.md) — Projekt anlegen und ersten Audit durchführen
2. [Chat](../bedienung/chat.md) — KI-gestützte Compliance-Beratung nutzen
